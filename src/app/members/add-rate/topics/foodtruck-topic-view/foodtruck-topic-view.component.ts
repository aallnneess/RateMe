...
@Component({
  selector: 'app-foodtruck-topic-view',
  templateUrl: './foodtruck-topic-view.component.html',
  styleUrl: './foodtruck-topic-view.component.css'
})
export class FoodtruckTopicViewComponent implements OnInit {
